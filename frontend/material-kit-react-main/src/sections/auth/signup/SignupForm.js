        ...
        <>
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    ...
                    // birth: Yup.string().max(255).required('birth is required')
                })}
                onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                    const response = await axios
                            .post("http://127.0.0.1:8000/cellphone/register/", values)
                            .catch((err) => {
                            ...
                            {/* <Grid item xs={12}>
                                <Stack spacing={1}>
                                    ...
                                    {touched.birth && errors.birth && (
                                            <FormHelperText error id="helper-text-birth">
                                                {errors.birth}
                                            </FormHelperText>
                                    )}
                                </Stack>
